...
def read_poi_examples(input_file, is_training):
    """Read a poi csv file into a list of SquadExample."""
    datas = []
    with tf.gfile.Open(input_file, "r") as csvfile:
...
def main(_):
    ...
    if FLAGS.do_train:
        train_examples = read_poi_examples(
